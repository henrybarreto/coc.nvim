...
export abstract class BaseLanguageClient {
  ...
  public getFeature(request: typeof InlineValueRequest.method): DynamicFeature<TextDocumentRegistrationOptions> &
